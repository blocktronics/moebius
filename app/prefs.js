...
const default_values = {nick: "Anonymous", group: "", use_flashing_cursor: false, use_pixel_aliasing: false, use_numpad: false, chunked_undo: true, hide_scrollbars: false, unsaved_changes: true, scroll_margin: 0, new_document_rows: 25, use_backup: false, backup_folder: ""};
const fs = require("fs");
