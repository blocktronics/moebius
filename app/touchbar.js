...
function get_drawgrid_size(win) {
    win.setTouchBar(simple_touch_bar(win, "OK"));
}
...
module.exports = {create_touch_bars, get_sauce_info, get_canvas_size, get_drawgrid_size, select_attribute, new_connection, splash_screen};
